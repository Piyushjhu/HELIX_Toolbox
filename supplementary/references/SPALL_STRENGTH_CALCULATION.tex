...
\subsection{DNS Check 1: P3 Must Be Positive}
The pullback minimum must remain strictly positive:
\begin{equation}
v_{P3} \leq 0 \text{ m/s} \quad \Rightarrow \quad \text{DNS}
\end{equation}
Zero or negative free-surface velocity at P3 is not a valid spall measurement.
